...
problema...
É uma fria manhã de inverno, você pega uma xícara de café, liga seu computador e começa a ler seus emails como de costume.
...
consultar na documentação oficial da linguagem: https://developer.mozilla.org/ptBR/docs/Web/JavaScript/Reference/Global_Objects/Array
O método length
...
Trampo!
Agora usando a mesma função usando o indexOf (que aquele programador macanudo deixou pronto pra
gente):
var nomes = ["Bruno", "Zezinho", "Fulano", "Douglas"];
var busca = "Fulano";
...
console.log("Encontrei o " + busca + " em: " + indice);
// → Encontrei o Fulano em: -1
O retorno do método indexOf retorna a posição do valor que encontrou ou então -1 caso não tenha
encontrado nada.
É interessante observar que o indexOf faz apenas buscas exatas, caso sua pesquisa esteja faltando um
pedaço da palavra, faltando acento ou até com letras caixa diferente (minúsculas ou maiúsculas)... Não vai
funcionar.
Veja:
var nomes = ["Bruno", "Zezinho", "Fulano", "Douglas"];
...
console.log("Encontrei o " + busca + " em: " + indice);
// → Encontrei o Fulano em: -1
Sendo assim o indexOf é bem útil quando estamos em busca de um array conhecido (que foi produzido
pelo seu próprio programa). Se for algo que um usuário digitou, por experiência, não use isso!
...
// → l
// → á
Devido as propriedades arraylisticas de uma string os mesmos métodos de array podem ser aplicados
tranquilamente!
Desafio
